...
router.get("/forgot",admincontroller.adminForgot)
router.post("/forgot",admincontroller.adminForgotPost)
router.get("/otpforgot",admincontroller.adminOtpForgot)
router.post("/otpforgot",admincontroller.adminOtpverification)
router.get("/resetPassword",admincontroller.adminResetPassword)
router.post("/resetPassword",admincontroller.adminResetPasswordPost)
